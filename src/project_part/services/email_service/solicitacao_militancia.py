...
async def enviar_email_solicitacao_militancia(email_destino: str, nome_completo: str, data_solicitacao: datetime):
    try:
        content = env.get_template('solicitacao_militancia.html')
    ...
    mensagem['Subject'] = 'solicitacao de militancia'
